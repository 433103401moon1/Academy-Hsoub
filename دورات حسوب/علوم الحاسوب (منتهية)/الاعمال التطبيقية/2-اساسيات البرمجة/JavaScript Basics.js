...
//     // كما يمكننا منع قيم او نتائج معينه وكتابه رساله الخطا في حال وجودها كما هنا
// function sum (a,b){
//     if (typeof a != "number") throw new Error('The first parameter is not number')
//     if (typeof b != "number") throw new Error('The second parameter is not number')
//     return a + b;
//     }
// try { // هنا الكود
//     let myDate = new Date();
...
// let myfile = require('fs'); // يجب ان تكتب الامر هكذا تماما وتستطيغ فقط تغيير اسم المتغير
// myfile.readFile('./HTML.html', 'utf8', (error, data) => { // يمكن تغيير اسم المعاملات هنا المهم هو لديه معاملين الاول سيكون الخطا والثاني هو البيانات داخل الملف
//     if (error) console.log(error);
//     else {
//         console.log(data.split('<')); // split تقوم بتقيم النص حسب رمز معين
//     }
// });
// console.log("hello") // تم طباعة هذه الكلمة قبل الامر السابق وذلك لان الامر السابق اذا تاخر يتم تنفيذ السطر الذي بعده وهذا من مزايا

// // -------------------05. كتابة الملفات Files Writing---------------------
// let myfile = require('fs'); // يجب ان تكتب الامر هكذا تماما وتستطيغ فقط تغيير اسم المتغير
// myfile.writeFile('./writeFile.txt', 'this is test write on file\nHeillo.', 'utf8', error => { // يمكن تغيير اسم المعاملات هنا المهم هو لديه معاملين الاول سيكون الخطا والثاني هو البيانات داخل الملف
//     if (error) console.log(error);
//     else {
//         console.log("The file was written successfully");
//     }
// });
// let arr = ["ahmed", "mohmmed", "fahad", "ali"];
// console.log(arr.join(',')); // دمج النصوص مع بعضها ووضع فاصل بينهم

// -------------------05. كتابة الملفات Files Writing---------------------
// let myfile = require('fs'); // يجب ان تكتب الامر هكذا تماما وتستطيغ فقط تغيير اسم المتغير
// myfile.appendFile('./writeFile.txt', 'this is test write on file\nHeillo.', 'utf8', error => { 
//     if (error) console.log(error);
//     else {
//         console.log("The file was appendFile successfully");
//     }
// });

// let myfile = require('fs'); // يجب ان تكتب الامر هكذا تماما وتستطيغ فقط تغيير اسم المتغير
// myfile.rename('./writeFile.txt', './writeFiles.txt', error => { 
//     if (error) console.log(error);
//     else {
//         console.log("The file was rename successfully");
//     }
// });

// let myfile = require('fs'); // يجب ان تكتب الامر هكذا تماما وتستطيغ فقط تغيير اسم المتغير
// myfile.unlink('./writeFile.txt', error => { 
//     if (error) console.log(error);
//     else {
//         console.log("The file was delete successfully");
//     }
// });

// -------------------07. الإدخال والإخراج I/O---------------------
// let readline = require('readline');
// let rl = readline.createInterface({ // يمكن من خلالها التفاعل مع المستخدم داخل الكونسول
//     input : process.stdin,
//     output : process.stdout
// });
// rl.question("what's your name?", answer => { // طرح سوال
//     console.log(`hello ${answer}`);
//     rl.close(); // لاغلاق التفاعل
// });

// -------------------02. خوارزمية الفرز الفقاعي Bubble Sort (تنفيذ)---------------------
let arr = [2,5,1,1,6,7,9,10];
// arr[2] = arr[1];
// arr[1] = arr[2];
let temp = 0;
